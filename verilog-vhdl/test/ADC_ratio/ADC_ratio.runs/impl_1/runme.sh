...
HD_PWD='C:/Users/matta/Documents/2025 Fall/Research/RP_Dev_Par_Lev/verilog-vhdl/test/ADC_ratio/ADC_ratio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adc_ratio.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adc_ratio.tcl -notrace
