...
HD_PWD='C:/Users/matta/Documents/2025 Fall/Research/RP_Dev_Par_Lev/verilog-vhdl/test/ADC_ratio/ADC_ratio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adc_ratio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adc_ratio.tcl
